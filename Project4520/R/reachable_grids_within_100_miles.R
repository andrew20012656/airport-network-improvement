#' dataframe that contains information about proportion of reachable grid points
#' within 100 miles from every point in `lonlat_usa`
#'
...
#' }
"reachable_grids_within_100_miles"
